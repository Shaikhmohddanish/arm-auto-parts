            ...
            <div className="bg-card rounded-lg p-8 shadow-sm border space-y-6">
              <section>
                <p className="text-muted-foreground leading-relaxed">
                  At Arm Auto Parts, accessible from armautoparts.com, one of our main priorities is the privacy of our
                  visitors. This Privacy Policy document contains types of information that is collected and recorded by
                  Arm Auto Parts and how we use it.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  with regards to the information that they shared and/or collect in Arm Auto Parts. This policy is not
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Arm Auto Parts follows a standard procedure of using log files. These files log visitors when they
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Like any other website, Arm Auto Parts uses 'cookies'. These cookies are used to store information
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Arm Auto Parts does not knowingly collect any Personal Identifiable Information from children under
